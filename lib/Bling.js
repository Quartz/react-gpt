...
var Bling = (_temp2 = _class = function (_Component) {
    ...
    _createClass(Bling, [{
        ...
        value: function render() {
            ...
            if (!scriptLoaded || shouldNotRender) {
                ...
                return _react2.default.createElement("div", { className: "placeholder" });
            }
            ...
            return _react2.default.createElement("div", { className: className, id: this._divId });
        }
    }, {
        key: "adSlot",
        get: function get() {
    ...
    /**
     * An optional class to be used on the container
     *
     * @property className
     */
